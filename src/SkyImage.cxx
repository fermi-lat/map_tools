...
, m_total(0)
{
    ...
    Primary::setBufferSize(m_naxis1*m_naxis2);
    Primary::setScale(1.0);
    m_data.resize(m_naxis1*m_naxis2);

    // fill the boundaries with NaN
#if 0// ?? takes too long, investigate
    ...
    setKey("CRPIX2",  SkyDir::s_refY+0.5);
    setKey("CRVAL2",  SkyDir::s_refDEC); // note that FITS pixel reference is off by 0.5
